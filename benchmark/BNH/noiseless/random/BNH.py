...
def obj1(grid):
	return 4.0*np.power(grid[:,0],2.0)+4.0*np.power(grid[:,1],2.0)

def obj2(grid):
	return np.power(grid[:,0]-5.0,2.0)+np.power(grid[:,1]-5.0,2.0)

def c1(grid):
	return ((25.0-np.power(grid[:,0]-5.0,2.0)-np.power(grid[:,1],2.0)) / 7.92604994102)*-1.0

def c2(grid):
	return ((np.power(grid[:,0]-8.0,2.0)+np.power(grid[:,1]+3.0,2.0)-7.7) / 17.8066390633) * -1.0
