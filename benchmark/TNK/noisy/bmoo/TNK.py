...
def evaluate(job_id, params):
    ...
    c1 = (float(np.power(x,2.0)+np.power(y,2.0)-1.0-0.1*np.cos(16.0*np.arctan(x/float(y)))) + np.random.normal(0,0.048)) / 4.16011699565
    c2 = (float(0.5-np.power(x-0.5,2.0)-np.power(y-0.5,2.0)) + np.random.normal(0,0.048)) / 2.93877297293
...
def c1(grid):
        return (((np.power(grid[:,0],2.0)+np.power(grid[:,1],2.0)-1.0-0.1*np.cos(16.0*np.arctan(grid[:,0]/grid[:,1])))+np.random.normal(0,0.048))/4.16011699565)*-1.0

def c2(grid):
        return (((0.5-np.power(grid[:,0]-0.5,2.0)-np.power(grid[:,1]-0.5,2.0))+np.random.normal(0,0.048))/2.93877297293)*-1.0
