...
def test_grid():
    ...
    y = np.linspace( 0.0001,0.01,1000 )
    z = np.linspace( 1,3,1000 )
    x,y,z = np.meshgrid( x,y,z )

    c1 = np.power(10.0,5.0)-np.max((20.0*np.power(16.0+np.power(z,2.0),0.5)/(x*z),80.0*np.power(1.0+np.power(z,2.0),0.5)/(y*z)))
...
def c1(grid):
	return ((np.power(10.0,5.0)-np.maximum(20.0*np.power(16.0+np.power(grid[:,2],2.0),0.5)/(grid[:,0]*grid[:,2]),80.0*np.power(1.0+np.power(grid[:,2],2.0),0.5)/(grid[:,1]*grid[:,2]))) / 103324.527134)*-1.0
